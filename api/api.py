    ...
    if len(dbQuery) > 0:
        ...
        for query in dbQueryActive:
            if query.liquidated == False:
                ...
                liqEntrants.append(query.username)
